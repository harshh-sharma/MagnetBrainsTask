      ...
      <div className=" bg-opacity-90 p-8 rounded-lg shadow-lg w-96 transform transition-all duration-300 hover:scale-105">
        ...
        <form onSubmit={handleSubmit}>
          <input
            ...
            className="w-full focus:ring-2 focus:ring-blue-500 focus:outline-none mb-4 px-4 py-3 rounded-lg text-indigo-500 placeholder-gray-400 transition-all"
            value={name}
          ...
          <div className="relative mb-4">
            <input
              ...
              className="w-full  focus:ring-2 focus:ring-blue-500 focus:outline-none px-4 py-3 rounded-lg text-indigi-500 placeholder-gray-400 transition-all"
              value={password}
          ...
          <div className="relative mb-4">
            <input
              ...
              className="w-full focus:ring-2 focus:ring-blue-500 focus:outline-none px-4 py-3 rounded-lg text-indigo-500 placeholder-gray-400 transition-all"
        ...
        <div className="flex justify-between mt-4 text-gray-400 text-sm">
          <a href="/login" className="text-black hover:text-indigo-500">Already have an account? Login</a>
        </div>
      </div>
    </div>
  );
